...
/**
 * @file
 * Contains \Acquia\Lightning\MakeParser.
 */

namespace Acquia\Lightning;

/**
 * Serializes and de-serializes data to and from legacy make format.
 */
class MakeParser {

  /**
   * Parses legacy make files. This is D7's drupal_parse_info_format().
   *
   * @param string $data
   *   The data to parse.
   *

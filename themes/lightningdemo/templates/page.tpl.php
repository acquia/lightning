...
<!-- special moderate layout for when workbench is enabled on a content type -->
    ...
    <!--/.l-off canvas -->
      <section class="off-canvas-wrap">
        ...
        <a class="left-off-canvas-toggle tiny button" href="#" >Moderate <?php if (isset($node) && ($node->type) != null) { ?><?php print node_type_get_name($node->type); ?><?php } ?><br /><span class="activestate"><?php if (isset($activestate)) print '(Currently Viewing: ' . $activestate . ')' ?></span></a>
